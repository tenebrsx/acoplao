  ...
  return (
    <div className="animate-in delay-100 h-full flex flex-col px-6 pb-6 pt-4 max-w-[1600px] mx-auto">
      ...
      <div className="flex justify-between items-center mb-6 shrink-0">
        <div>
          <Link href={`/dashboard/projects/${projectId}`} className="inline-flex items-center gap-2 text-[var(--text-tertiary)] text-sm mb-3 hover:text-white transition-colors">
