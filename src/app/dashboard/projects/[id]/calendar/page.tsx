...
export default async function ProjectCalendarPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  async function togglePhase(formData: FormData) {
    ...
    revalidatePath(`/dashboard/projects/${id}/calendar`)
  }
  ...
  return (
    <div className="animate-in delay-100">
      <Link href={`/dashboard/projects/${id}`} style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: 'var(--text-tertiary)', fontSize: '0.875rem', marginBottom: '24px', textDecoration: 'none' }}>
