...
export default async function BusinessDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="animate-in delay-100" style={{ maxWidth: '1400px', margin: '0 auto', paddingBottom: '64px' }}>
      <Link href="/businesses" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: 'var(--text-tertiary)', fontSize: '0.875rem', marginBottom: '24px', textDecoration: 'none', transition: 'color 0.2s' }}>
